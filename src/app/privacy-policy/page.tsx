...
const privacyPolicyPoints = [
  "Client data is secured & not being shared with third parties.",
  "Data is collected to fulfill the service, issue invoices, send project updates, respond to inquiries.",
];

const Page = () => {
  return (
    <main className="relative pb-10 md:pb-12 lg:pb-16">
      <div className="px-4 translate-y-0  z-10">
